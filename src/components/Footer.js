              ...
              <Row>
                  <div className="col-md-4 d-flex justify-content-center align-items-center align-items-md-start flex-column">
                      ...
                      <p className="text-white-50 fs-6 fw-lighter">
                          ...
                          operated by the Taverniti family since 1992. With
                          classic Italian dishes, we offer our clients a warm
                          atmosphere filled with friendly faces and aromas of
                          freshly made dough, sizzling pizza and savoury
                          espresso.
                      </p>
                  </div>
